...
public class LibrariesForLibs extends AbstractExternalDependencyFactory {
    ...
    private final EpoxyLibraryAccessors laccForEpoxyLibraryAccessors = new EpoxyLibraryAccessors(owner);
    ...
    /**
     * Group of libraries at <b>epoxy</b>
     */
    public EpoxyLibraryAccessors getEpoxy() {
        return laccForEpoxyLibraryAccessors;
    }
    ...
    public static class EpoxyLibraryAccessors extends SubDependencyFactory implements DependencyNotationSupplier {

        public EpoxyLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }

        /**
         * Dependency provider for <b>epoxy</b> with <b>com.airbnb.android:epoxy</b> coordinates and
         * with version reference <b>epoxy</b>
         * <p>
         * This dependency was declared in catalog libs.versions.toml
         */
        public Provider<MinimalExternalModuleDependency> asProvider() {
        ...
        /**
         * Dependency provider for <b>databinding</b> with <b>com.airbnb.android:epoxy-databinding</b> coordinates and
         * with version reference <b>epoxyDatabinding</b>
         * <p>
         * This dependency was declared in catalog libs.versions.toml
         */
        public Provider<MinimalExternalModuleDependency> getDatabinding() {
            return create("epoxy.databinding");
        }

        /**
         * Dependency provider for <b>processor</b> with <b>com.airbnb.android:epoxy-processor</b> coordinates and
         * with version reference <b>epoxy</b>
         * <p>
         * This dependency was declared in catalog libs.versions.toml
         */
        public Provider<MinimalExternalModuleDependency> getProcessor() {
            return create("epoxy.processor");
        }
    ...
    public static class VersionAccessors extends VersionFactory  {
        ...
        /**
         * Version alias <b>activityKtx</b> with value <b>1.6.1</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
        ...
        /**
         * Version alias <b>epoxy</b> with value <b>4.6.2</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
         * This version was declared in catalog libs.versions.toml
         */
        public Provider<String> getEpoxy() { return getVersion("epoxy"); }

        /**
         * Version alias <b>epoxyDatabinding</b> with value <b>5.1.3</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
         * This version was declared in catalog libs.versions.toml
         */
        public Provider<String> getEpoxyDatabinding() { return getVersion("epoxyDatabinding"); }
        ...
        /**
         * Version alias <b>lifecycleViewmodelKtx</b> with value <b>2.5.1</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
        ...
        /**
         * Version alias <b>navigationFragmentKtx</b> with value <b>2.5.1</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
